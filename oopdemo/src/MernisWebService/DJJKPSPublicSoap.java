...
public class DJJKPSPublicSoap
{
    ...
    public DJJKPSPublicSoap(){}

    public DJJKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public DJJKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        DJJExtendedSoapSerializationEnvelope envelope= new DJJExtendedSoapSerializationEnvelope(DJJExtendedSoapSerializationEnvelope.VER11);
