...
public class DJJExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(DJJDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new DJJStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static DJJDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static DJJDateTimeConverter dateTimeConverter = new DJJStandardDateTimeConverter();

    public DJJExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public DJJExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new DJJMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=DJJHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,DJJExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=DJJHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
