...
public class GCSKPSPublicSoap
{
    ...
    public GCSKPSPublicSoap(){}

    public GCSKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public GCSKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        GCSExtendedSoapSerializationEnvelope envelope= new GCSExtendedSoapSerializationEnvelope(GCSExtendedSoapSerializationEnvelope.VER11);
