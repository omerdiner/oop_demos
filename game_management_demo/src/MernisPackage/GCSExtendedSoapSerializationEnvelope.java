...
public class GCSExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(GCSDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new GCSStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static GCSDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static GCSDateTimeConverter dateTimeConverter = new GCSStandardDateTimeConverter();

    public GCSExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public GCSExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new GCSMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=GCSHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,GCSExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=GCSHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
